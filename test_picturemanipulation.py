...
class Test2filefunc(unittest.TestCase):
        ...
        def testfilledgradrect2file0smootherstep(self):
                self.dotestrectregionwithparam(
                        'raccoon-filledgradrectangle0smootherstep.bmp',
                        filledgradrect2file,
        ...
        def testfilledgradrect2file1smootherstep(self):
                self.dotestrectregionwithparam(
        ...
        def testfilledsmoothstepdichromaticgradrect2file0(self):
                self.dotestrectregionwithparam(
        ...
        def testfilledsmoothstepdichromaticgradrect2file1(self):
                self.dotestrectregionwithparam(
        ...
        def testfilledsmootherstepdichromaticgradrect2file0(self):
                self.dotestrectregionwithparam(
                        'raccoon-filleddichromaticgradrectangle0smootherstep.bmp',
                        filleddichromaticgradrect2file,
        ...
        def testsmootheststepsphere2file(self):
                self.dotestcircregionwith2param(
                        'raccoon-spheresmootheststep.bmp',
                        sphere2file,
                        120, 170, 100, self.cfcyan, smootheststeplerp)
        ...
        def testsmootherstepdichromicsphere2file(self):
                self.dotestcircregionwith2param(
                        'raccoon-spheredichromicsmootheststep.bmp',
                        sphere2file,
                        120, 170, 100, [self.cyellow, self.cred], smootheststeplerp)
