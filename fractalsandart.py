from BITMAPlib import getmaxcolors,plotxybit,sortrecpoints,bmpcolorbits,colormix,random,iif,isinBMPrectbnd,isinrectbnd,radians,cos,sin,range2baseanddelta,setmax,distance
