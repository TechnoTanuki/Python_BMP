...
def main():
        ...
        rotation=b.rotvec3D(40,80,50) # rotation vector (x,y,z) in degrees
        b.plot3Dsolid(bmp,[b.cubevert(40),sd["cube"]],isSolid,color,showoutline,outlinecolor,rotation,translationvector,d,cenpt)
