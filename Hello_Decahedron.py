...
def main():
        ...
        file='HelloDecahedron.bmp' # some random file name as string
        ...
        rotation=b.rotvec3D(30,20,20) # rotation vector (x,y,z) in degrees
        b.plot3Dsolid(bmp,b.decahedvertandsurface(50),isSolid,color,showoutline,outlinecolor,rotation,translationvector,d,cenpt)
