...
def main():
        ...
        bmp=b.newBMP(x,y,24) # (x,y,bit depth) 
        (x,y)=b.centercoord(bmp) # helper method to get center of a bitmap
        r=x-10 # radius of flower
        petals=1# for cardioid
        angrot=45 # angle of rotation in degrees
        lumrange=(255,240) # for brightness gradient
        rgbfactors=(1,1,0) # color as rgb of ufloat 0 to 1
        file='HelloCardioid.bmp' #file name
        b.plotflower(bmp,x,y,r,petals,angrot,lumrange,rgbfactors)
